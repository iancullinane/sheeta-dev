...
import { generateUserData } from './components/zomboid-server'
...
export class DevAppStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AppProps) {
    ...
    const hz = r53.HostedZone.fromHostedZoneAttributes(this, `${props.projectName}-hz-lookup`, {
    ...
    new r53.ARecord(this, `PzARecordB-${props.serverName}`, {
      zone: pzHz,
